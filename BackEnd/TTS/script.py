...
# Load text from provided text file
...
# Use the provided audio file for reference
# reference_files = [args.audio_file]
# for sample in reference_files:
...
# Comment out or remove the IPython-specific code
